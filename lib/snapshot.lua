...
function Snapshot.store_snapshot(snapshot_name, params, freqs)
    ...
    params:set("snapshot_" .. string.lower(snapshot_name) .. "_noise_lfo_rate_jitter_rate",
        params:get("noise_lfo_rate_jitter_rate"))
    params:set("snapshot_" .. string.lower(snapshot_name) .. "_noise_lfo_rate_jitter_depth",
        params:get("noise_lfo_rate_jitter_depth"))
...
function Snapshot.recall_snapshot(snapshot_name, params, freqs)
    ...
    params:set("noise_lfo_rate_jitter_rate",
        params:get("snapshot_" .. string.lower(snapshot_name) .. "_noise_lfo_rate_jitter_rate"))
    params:set("noise_lfo_rate_jitter_depth",
        params:get("snapshot_" .. string.lower(snapshot_name) .. "_noise_lfo_rate_jitter_depth"))
